...
anotherdf <- rep(thisdf,3) # you get a list

# here's a complex example
# I need Quarter identifiers for an unpredictable number of years
paste0(2003:2021,"-") # range of years
rep(paste0(2003:2021,"-"), 4) # 4x years - one for each quarter
sort(rep(paste0(2003:2021,"-"),4)) # sort by year
paste0(sort(rep(paste0(2003:2021,"-"),4)),c("Q1","Q2","Q3","Q4"))
