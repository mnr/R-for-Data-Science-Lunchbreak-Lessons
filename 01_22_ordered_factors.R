...
# main idea: sort by level, instead of numeric or alphabetic
...
drinks.ordered <- factor(size.of.drink.ordered.in.oz, 
                         levels=drink.sizes, 
                         labels=drink.names, 
                         ordered=TRUE)
# or, this is the same thing
drinks.ordered <- ordered(size.of.drink.ordered.in.oz, 
                          levels=drink.sizes, 
                          labels=drink.names)
