...
# =AVERAGEIF(A1:F1,">3") average of 1st row where numbers > 5
Spreadsheet[1,] # the first row of the spreadsheet
Spreadsheet[1,] >5 # produces True/False
...
AVERAGEIF(Spreadsheet[1,], ">3") # doesn't understand operators
AVERAGEIF(Spreadsheet[1,], "3") # insists on average range
