...
You | Me |
----|----|
Domain and statistical expertise | No domain or statistical expertise
A mandate to learn and use R | An interest in programming languages
You grumbled, but complied | I've gone **really** deep on the language
A Branch:<br>- Those who didn't need it anymore (not here today)<br>- Those who did (This is you!) | 
...
## Lesson: Research vs Education
Teaching R is different than Using R

Using  | Teaching
---|---
Do it in a way you best understand | Do it in the most straightforward manner
